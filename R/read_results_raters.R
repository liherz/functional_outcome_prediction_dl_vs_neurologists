...
dirs_raters <- c(paste0(DIR0, "prediction_challenge/rater1_susanne"),
                 paste0(DIR0, "prediction_challenge/rater2_christoph"),
                 paste0(DIR0, "prediction_challenge/rater3_mirjam"),
                 paste0(DIR0, "prediction_challenge/rater4_david"),
                 paste0(DIR0, "prediction_challenge/rater5_kateryna"))
